...
- Do **not** overwrite existing vault files without showing a diff and receiving approval.
...
## 2) Proposed Adds
- [target: user|project|reference] statement
- Rationale:
...
## Sample Prompt
"Curate the last week of activity into durable memory proposals for Obsidian. Proposal-only mode with Add/Replace/Remove/Skip sections."
...
- Vault path: `/home/zeke/Hermes-Vault` (confirm with user if unsure).
