...
metadata:
  hermes:
    tags: [career, resume, linkedin, portfolio, STAR, artifacts, job-search]
    category: career
    related_skills: [github-repo-review, obsidian-memory-curator, local-file-ops]
---

# Career Artifact Builder

## Trigger
Use this skill when the user asks to write resume bullets, draft a LinkedIn post about a project, build a portfolio case study, compose a STAR story, or turn Hermes/project activity into career-facing content.

## Required Inputs
- Source material: one or more of — project notes, Git commit history, README, Hermes session logs, task records, or a plain description of what was built/done.
...
3. **Draft requested artifact(s)**
   ...
   - Example structure: `Built and deployed an AI operations harness (Hermes) integrating Discord, Telegram, and scheduled agents, reducing manual monitoring overhead by centralizing alerts and reports.`
...
- [ ] Save approved artifacts to Obsidian or portfolio folder
```
...
## Sample Prompt
"Build career artifacts for the Hermes AI harness project. Source: the README, SOUL.md, and the fact that I built a multi-platform AI agent with Discord/Telegram integration, scheduled jobs, and a Mission Control dashboard. Target role: AI/ML Operations Engineer. Give me a resume bullet, a STAR story, and a LinkedIn post draft."

## Notes
- Hermes itself is a strong career differentiator: building a personal AI operations platform demonstrates systems thinking, automation capability, and hands-on AI integration.
...
- Save approved artifacts to Obsidian under a `Career/` vault folder for future retrieval.
